...
```mermaid
graph TB
    A[Upper-layer Applications<br/>Business Systems] --> B[AI Governance & Scheduling Platform<br/>Unified Entry]
    B --> C[Intelligent Scheduling Layer<br/>Model Selection / Fallback / Throttling]
    B --> D[Plugin Ecosystem Layer<br/>In-house AI Components / Business Plugins]
    B --> E[Service Registry Layer<br/>Traditional ML / External AI Services]
    C --> F[Model Pool<br/>Multiple LLM Vendors / Private Models]
    D --> G[Prompt Template Center<br/>Best-practice Library]
    E --> H[Registered Service Catalog]
    B --> I[Monitoring & Cost Governance<br/>QPS / Health / Tokens / Cost]
```
